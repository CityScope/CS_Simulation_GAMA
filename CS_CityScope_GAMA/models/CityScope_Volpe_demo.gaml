...
experiment CityScopeVolpeDemo type: gui parent:CityScopeMainVirtual{
	action _init_ {
		create CityScope_Kendall_Volpe_Demo_model with: [cityScopeCity::"volpe",angle :: -9.74,center ::{1007,632}, brickSize :: 21.3]; // for older version of GAMA center <-{3305,2075} brickSize <-  70.0;	
	}
